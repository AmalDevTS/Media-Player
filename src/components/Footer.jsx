      ...
      <div className='d-flex justify-content-center align-items-center mt-5'>
        <div className='footer d-flex align-item-center justify-content-evenly'>
          <div className='website' style={{ width: "400px" }}>
            ...
            <p style={{ textAlign: "justify" }}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Delenitinon qui aspernatur modi! Saepe beatae nostrum, ab repudiandae ullam quaerat fuga voluptatibus, fugit dolor nobis ea inciduntvoluptatem, in minima!</p>
